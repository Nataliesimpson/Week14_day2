...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NetflixSelect = __webpack_require__(160);
	var NetflixDetail = __webpack_require__(161);
	...
	var NetflixBox = React.createClass({
	  ...
	  setCurrentFilm: function setCurrentFilm(film) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(NetflixSelect, { films: this.state.films, setCurrentFilm: this.setCurrentFilm }),
	      React.createElement(NetflixDetail, { film: this.state.currentFilm })
	    );
	  }
	});
